...
@pytest.mark.parametrize(
    ...
    [
        ...
        ({}, False, True, False, False, True, PRESET_MODE_AUTO),
        ({}, False, True, False, True, False, PRESET_MODE_AUTO_PLASMA),
        ({}, False, False, True, False, True, PRESET_MODE_MANUAL),
        ({}, False, False, True, True, False, PRESET_MODE_MANUAL_PLASMA),
    ],
)
